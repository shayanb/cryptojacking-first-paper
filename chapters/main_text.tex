...
\vspace*{-1mm}
\begin{center}
	\makebox[1\textwidth]{\includegraphics[width=0.75\textwidth]{coinhive_experiment_11k.png}}
	\caption{Analytics of the Coinhive experiment - Coinhive Dashboard and Google Analytics results}
\end{center}
\vspace*{-1mm}

This experiment showed that even though the number of users visiting was significant, the profit from those visits was below expectations. For the three-month period, the revenue was 0.02417 Monero, which at the time of writing this is equivalent to 7.69 USD.
