...
% HERE: Chart of the coinhive usage over time? 
...
\begin{center}
	\makebox[1\textwidth]{\includegraphics[width=1\textwidth]{usage_over_time.png}}
\end{center}
