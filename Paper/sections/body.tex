...
On October 13, Coinhive was found on the political fact-checking website Politifact. A compromised JavaScript library was found to be injecting the cryptojacking scripts. The malicious code remained on the site for at least four hours before it was removed. (Cite: https://www.washingtonpost.com/news/the-switch/wp/2017/10/13/hackers-have-turned-politifacts-website-into-a-trap-for-your-pc/)In a statement provided to The Wall Street Journal, PolitiFact Executive Director Aaron Sharockman stated, “Hackers were able to install their script on the fact-checking website after discovering a misconfigured cloud-computing server.” (Cite: https://www.wsj.com/articles/hackers-latest-move-using-your-computer-to-mine-bitcoin-1509102002)

An attacker can hack a service provider's codebase and inject their mining code to the numerous websites at once. A recent example of this type of attack, discovered on Thanksgiving Day by security researcher Troy Mursch, occurred to LiveHelpNow's SDK that resulted in unsolicited mining when accessing their chat system through a website~\cite{chatsupporthack}.
...
In two separate incidents, Coinhive was injected into the websites of Globovisión and Movistar using Google Tag Manager. Movistar stated that Coinhive was not put on their website by a hacker, but instead was due to “an internal error” while they were conducting “pre-production tests.” No statement was provided by Globovisión on why the cryptojacking scripts appeared on their site on November 15, 2017. (Cite: https://www.theregister.co.uk/2017/11/22/cryptojackers_google_tag_manager_coin_hive/)

\subsection{Browser extensions} 
Cryptojacking was not limited to websites in 2017 as we saw Chrome extensions also being affected. One such extension, Archive Poster, remained on the Chrome Web Store for days while silently cryptojacking an unknown portion of their 100,000+ users. Despite multiple user reports, Google’s security team did not remove the extension until multiple news media outlets covered the issue. (Cite: http://fortune.com/2018/01/02/google-chrome-extension-cryptocurrency-mining-monero/)
