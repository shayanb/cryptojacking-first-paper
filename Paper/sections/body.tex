...
\begin{table}[]
\centering
\caption{Coinhive miner data was gathered by totalling the number of websites, indexed by PublicWWW by 12/24/2017, which had the following libraries in their source codes:  }
...
\caption{Share of websites using a Javascript cryptocurrency miner \label{fig:coinhivevscopycats}}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.9\linewidth]{figures/non-coinhive-miners-pie.png}
\caption{Share of websites using a Coinhive alternative \label{fig:copycat}}
\end{figure}
